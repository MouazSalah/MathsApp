...
public class Multiplication extends AppCompatActivity
{
    ...
    public void GenerateNumbers()
    {
        ...
        {
            firstNumber = random.nextInt(5);
            secondNumber = random.nextInt(5);
        }
        else if (levelOfGame == 3 )
        {
            firstNumber = random.nextInt(7);
            secondNumber = random.nextInt(7);
        }
        else if (levelOfGame == 4 )
        {
        ...
        {
            firstNumber = random.nextInt(13);
            secondNumber = random.nextInt(13);
        }
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            {
                int inCorrectAnswer = random.nextInt(145);
                if (sum == inCorrectAnswer)
                {
                    answers.add(random.nextInt(145));
                }
                else
                {
        ...
        operationTextView.setText(firstNumber + " x " + secondNumber);
    ...
    public void CheckAnswer(View v)
    {
        ...
        scoreTextView.setText(score + "x" + numberOfQuestion);
